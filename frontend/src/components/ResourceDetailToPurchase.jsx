        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-8 space-y-5 border-r border-gray-100">
              ...
              {/* ① Image */}
              <div className={`relative bg-gray-100 rounded-xl overflow-hidden flex items-center justify-center h-[320px] ${(!resource.copiesSold || resource.copiesSold === "" || resource.copiesSold === 0)
                  ? 'md:h-[440px]'
                  : 'md:h-[340px]'
                }`}><img
                  src={resource.image}
